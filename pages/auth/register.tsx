...
export default function Register() {
    ...
    const handleRegister = () => {
        ...
        if (password === password2) {
            axios.post(process.env.SERVER_ADRESS + "/register", {}, {
                data: {
                    username,
                    password
                }
    ...
    return (
        <div className={`flex flex-col items-center w-screen`}>
            <div className={`flex flex-col justify-bettwen space-y-2xl rounded shadow-lg border border-[#e6e6e6] text-center px-10 py-3 mt-10`}>
                ...
                <div>
                    ...
                    <p className={`mt-10 flex flex-row`}>
                        ...
                        <Link href="/auth/login">
                            <p className={`text-blue-300 ml-1`}>
                                login
                            </p>
                        </Link>
                    </p>
